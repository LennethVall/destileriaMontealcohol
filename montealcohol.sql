...
CREATE TABLE Producto (
    ...
    Precio_Pro     FLOAT(10,2) NOT NULL CHECK (Precio_Pro > 0),
...
CREATE TABLE Pedido (
    ...
    Precio_Total_Ped FLOAT(10,2) NOT NULL CHECK (Precio_Total_Ped > 0),
...
CREATE TABLE Contiene (
    ...
    Precio_Total   FLOAT(10,2) NOT NULL CHECK (Precio_Total > 0),
...
DETERMINISTIC
BEGIN
    DECLARE V_TOTAL FLOAT(10,2) DEFAULT 0;
...
DETERMINISTIC
BEGIN
    DECLARE V_PRECIO FLOAT(10,2) DEFAULT 0;
...
BEGIN
    ...
    DECLARE V_CANT INT;
    DECLARE V_PRECIOUNIT FLOAT(10,2);
    DECLARE V_DESCUENTO INT;
    DECLARE V_PRECIO_FINAL FLOAT(10,2);
